...
> [!NOTE]
> **New: GuardingPearSoftware Dashboard**
>
> We’re excited to announce the **GuardingPearSoftware Dashboard**, a new platform where you can manage all your **GuardingPearSoftware assets and tools** in one place.
>
> **Coming later this year**, the dashboard will introduce **deeper integrations** with our tools and unlock **exclusive features** that would normally require running your own server instance.
>
> 👉 **Register here:**  
> https://dashboard.guardingpearsoftware.com/register
>
> **Currently supported tools**
> - AntiCheat Pro  
> - Obfuscator Pro  
>
> Support for **all other GuardingPearSoftware tools will be added soon.**
>
> **Benefits of using the dashboard:**
> - Get **earlier access to new versions**
> - Try **beta releases**
> - Download **older versions** when needed
>
> **Note for developers in China 🇨🇳**
>
> Starting **April**, the global store will close for your region and be replaced by a **China regional store**. Unfortunately, this means you may **lose access to assets previously purchased through the global store**.
>
> By using the **GuardingPearSoftware Dashboard**, you will **retain access to your assets** independently of the store changes.
>
> We are also working on **integration with the China Asset Store**, though this will take a bit more time.
...
- **Read_Me.md:** The readme file (this file).
- **Version_History.md:** This file contains a detailed record of all the changes made in each version of the asset.
